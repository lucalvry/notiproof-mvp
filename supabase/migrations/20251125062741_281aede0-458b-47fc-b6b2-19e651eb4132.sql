-- PHASE 1: Fix testimonial_split_view template - Restore correct background and remove duplicate avatar
-- Reverts bad changes from migration 20251125060029
-- Restores correct version from migration 20251125045936
...
-- SELECT template_key, 
--        html_template LIKE '%background: rgba(255, 255, 255, 0.98)%' as has_background,
--        html_template LIKE '%backdrop-filter: blur(10px)%' as has_blur,
--        html_template LIKE '%split-author%split-avatar%' as has_duplicate_avatar
-- FROM templates 
