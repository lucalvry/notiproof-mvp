...
-- Note: Run this SQL in Supabase SQL Editor to seed the templates
-- Clean up existing testimonial templates (optional - for fresh seed)
...
-- Expected result: 6 testimonial templates
-- testimonial_card_v1, testimonial_card_v2, testimonial_compact_v1, 
-- testimonial_bubble_v1, testimonial_hero_v1, testimonial_video_v1
